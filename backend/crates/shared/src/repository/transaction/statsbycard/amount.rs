use crate::{
    abstract_trait::transaction::repository::statsbycard::amount::TransactionStatsAmountByCardRepositoryTrait,
...
pub struct TransactionStatsAmountByCardRepository {
    db: ConnectionPool,
}

impl TransactionStatsAmountByCardRepository {
...
#[async_trait]
impl TransactionStatsAmountByCardRepositoryTrait for TransactionStatsAmountByCardRepository {
