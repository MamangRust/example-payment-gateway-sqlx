use crate::{
    abstract_trait::transaction::repository::stats::status::TransactionStatsStatusRepositoryTrait,
...
pub struct TransactionStatsStatusRepository {
    db: ConnectionPool,
}

impl TransactionStatsStatusRepository {
...
#[async_trait]
impl TransactionStatsStatusRepositoryTrait for TransactionStatsStatusRepository {
