use crate::{
    abstract_trait::merchant::repository::statsbymerchant::method::MerchantStatsMethodByMerchantRepositoryTrait,
...
pub struct MerchantStatsMethodByMerchantRepository {
    db: ConnectionPool,
}

impl MerchantStatsMethodByMerchantRepository {
...
#[async_trait]
impl MerchantStatsMethodByMerchantRepositoryTrait for MerchantStatsMethodByMerchantRepository {
