use crate::{
    abstract_trait::merchant::repository::statsbyapikey::amount::MerchantStatsAmountByApiKeyRepositoryTrait,
...
pub struct MerchantStatsAmountByApiKeyRepository {
    db: ConnectionPool,
}

impl MerchantStatsAmountByApiKeyRepository {
...
#[async_trait]
impl MerchantStatsAmountByApiKeyRepositoryTrait for MerchantStatsAmountByApiKeyRepository {
