...
pub struct CardStatsWithdrawService {
    pub withdraw: DynCardStatsWithdrawRepository,
    pub tracing_metrics_core: TracingMetrics,
    pub cache_store: Arc<CacheStore>,
}

impl CardStatsWithdrawService {
    pub fn new(withdraw: DynCardStatsWithdrawRepository, shared: &SharedResources) -> Result<Self> {
        Ok(Self {
            withdraw,
...
impl CardStatsWithdrawServiceTrait for CardStatsWithdrawService {
    async fn get_monthly_amount(
        ...
        let amounts = match self.withdraw.get_monthly_amount(year).await {
            Ok(amounts) => {
                info!(
    ...
    async fn get_yearly_amount(
        ...
        let amounts = match self.withdraw.get_yearly_amount(year).await {
            Ok(amounts) => {
                info!(
