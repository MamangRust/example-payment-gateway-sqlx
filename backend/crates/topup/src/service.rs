...
impl TopupService for TopupServiceImpl {
    ...
    async fn find_all_topup(
        ...
        match self.di.topup_query.find_all(&domain_req).await {
            Ok(api_response) => {
    ...
    async fn find_by_id_topup(
        ...
        match self.di.topup_query.find_by_id(req.topup_id).await {
            Ok(api_response) => {
    ...
    async fn find_by_card_number_topup(
        ...
        match self.di.topup_query.find_by_card(&req.card_number).await {
            Ok(api_response) => {
    ...
    async fn find_by_active(
        ...
        match self.di.topup_query.find_active(&domain_req).await {
            Ok(api_response) => {
    ...
    async fn find_by_trashed(
        ...
        match self.di.topup_query.find_trashed(&domain_req).await {
            Ok(api_response) => {
    ...
    async fn create_topup(
        ...
        match self.di.topup_command.create(&domain_req).await {
            Ok(api_response) => {
                info!(
    ...
    async fn update_topup(
        ...
        match self.di.topup_command.update(&domain_req).await {
            Ok(api_response) => {
                info!(
    ...
    async fn trashed_topup(
        ...
        match self.di.topup_command.trashed(req.topup_id).await {
            Ok(api_response) => {
    ...
    async fn restore_topup(
        ...
        match self.di.topup_command.restore(req.topup_id).await {
            Ok(api_response) => {
    ...
    async fn delete_topup_permanent(
        ...
        match self.di.topup_command.delete_permanent(req.topup_id).await {
            Ok(api_response) => {
    ...
    async fn restore_all_topup(
        ...
        match self.di.topup_command.restore_all().await {
            Ok(api_response) => {
    ...
    async fn delete_all_topup_permanent(
        ...
        match self.di.topup_command.delete_all().await {
            Ok(api_response) => {
