...
impl TransferService for TransferServiceImpl {
    ...
    async fn find_all_transfer(
        ...
        match self.di.transfer_query.find_all(&domain_req).await {
            Ok(api_response) => {
                info!(
    ...
    async fn find_by_id_transfer(
        ...
        match self.di.transfer_query.find_by_id(req.transfer_id).await {
            Ok(api_response) => {
                info!("✅ Transfer found.");
    ...
    async fn find_transfer_by_transfer_from(
        ...
        match self
            .di
            .transfer_query
            .find_by_transfer_from(&req.transfer_from)
            .await
        {
            Ok(api_response) => {
    ...
    async fn find_transfer_by_transfer_to(
        ...
        match self
            .di
            .transfer_query
            .find_by_transfer_to(&req.transfer_to)
            .await
        {
            Ok(api_response) => {
                let grpc_response = ApiResponseTransfers {
    ...
    async fn find_by_active_transfer(
        ...
        match self.di.transfer_query.find_by_active(&domain_req).await {
            Ok(api_response) => {
    ...
    async fn find_by_trashed_transfer(
        ...
        match self.di.transfer_query.find_by_trashed(&domain_req).await {
            Ok(api_response) => {
                let grpc_response = ApiResponsePaginationTransferDeleteAt {
                    data: api_response.data.into_iter().map(Into::into).collect(),
                    pagination: Some(api_response.pagination.into()),
    ...
    async fn create_transfer(
        ...
        match self.di.transfer_command.create(&domain_req).await {
            Ok(api_response) => {
                let grpc_response = ApiResponseTransfer {
                    data: Some(api_response.data.into()),
                    message: api_response.message,
    ...
    async fn update_transfer(
        ...
        match self.di.transfer_command.update(&domain_req).await {
            Ok(api_response) => {
                let grpc_response = ApiResponseTransfer {
                    data: Some(api_response.data.into()),
                    message: api_response.message,
    ...
    async fn trashed_transfer(
        ...
        match self.di.transfer_command.trashed(req.transfer_id).await {
            Ok(api_response) => {
    ...
    async fn restore_transfer(
        ...
        match self.di.transfer_command.restore(req.transfer_id).await {
            Ok(api_response) => {
                let grpc_response = ApiResponseTransferDeleteAt {
                    data: Some(api_response.data.into()),
                    message: api_response.message,
    ...
    async fn delete_transfer_permanent(
        ...
        match self
            .di
            .transfer_command
            .delete_permanent(req.transfer_id)
            .await
        {
            Ok(api_response) => {
    ...
    async fn restore_all_transfer(
        ...
        match self.di.transfer_command.restore_all().await {
            Ok(api_response) => {
    ...
    async fn delete_all_transfer_permanent(
        ...
        match self.di.transfer_command.delete_all().await {
            Ok(api_response) => {
                let grpc_response = ApiResponseTransferAll {
                    message: api_response.message,
                    status: api_response.status,
