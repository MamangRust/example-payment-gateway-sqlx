...
impl CardService for CardServiceImpl {
    ...
    async fn find_all_card(
        ...
        match self.di.card_query.find_all(&domain_req).await {
            Ok(api_response) => {
    ...
    async fn find_by_id_card(
        ...
        match self.di.card_query.find_by_id(req.card_id).await {
            Ok(api_response) => {
            ...
            Err(e) => {
                error!("❌ Failed to find card by ID: {e:?} 🚨",);
                Err(AppErrorGrpc::from(e).into())
            }
        }
    }
    ...
    async fn find_by_user_id_card(
        ...
        match self.di.card_query.find_by_user_id(req.user_id).await {
            Ok(api_response) => {
                info!(
    ...
    async fn find_by_active_card(
        ...
        match self.di.card_query.find_active(&domain_req).await {
            Ok(api_response) => {
    ...
    async fn find_by_trashed_card(
        ...
        match self.di.card_query.find_trashed(&domain_req).await {
            Ok(api_response) => {
                let data: Vec<genproto::card::CardResponseDeleteAt> =
                    api_response.data.into_iter().map(Into::into).collect();
                let total_items = api_response.pagination.total_items;
    ...
    async fn find_by_card_number(
        ...
        match self.di.card_query.find_by_card(&req.card_number).await {
            Ok(api_response) => {
                let reply = ApiResponseCard {
                    data: Some(api_response.data.into()),
                    message: api_response.message,
    ...
    async fn dashboard_card(
        ...
        match self.di.card_dashboard.get_dashboard().await {
            Ok(api_response) => {
                info!(
                    "✅ Successfully fetched dashboard card, status={}",
                    api_response.status
                );
    ...
    async fn dashboard_card_number(
        ...
        match self
            .di
            .card_dashboard
            .get_dashboard_bycard(req.card_number.clone())
            .await
        {
            Ok(api_response) => {
                info!(
    ...
    async fn find_monthly_balance(
        ...
        match self.di.stats_balance.get_monthly_balance(req.year).await {
            Ok(api_response) => {
                info!(
            ...
            Err(e) => {
                error!(
                    "❌ Failed to fetch monthly balance for year={}, error={e:?}",
                    req.year
                );
                Err(AppErrorGrpc::from(e).into())
            }
    ...
    async fn find_yearly_balance(
        ...
        match self.di.stats_balance.get_yearly_balance(req.year).await {
            Ok(api_response) => {
                info!(
            ...
            Err(e) => {
                error!(
                    "❌ Failed to fetch yearly balance for year={}, error={e:?}",
                    req.year
                );
                Err(AppErrorGrpc::from(e).into())
            }
    ...
    async fn find_monthly_topup_amount(
        ...
        match self.di.stats_topup.get_monthly_amount(req.year).await {
            Ok(api_response) => {
                info!(
    ...
    async fn find_yearly_topup_amount(
        ...
        match self.di.stats_topup.get_yearly_amount(req.year).await {
            Ok(api_response) => {
                info!(
    ...
    async fn find_monthly_withdraw_amount(
        ...
        match self.di.stats_withdraw.get_monthly_amount(req.year).await {
            Ok(api_response) => {
                info!(
    ...
    async fn find_yearly_withdraw_amount(
        ...
        match self.di.stats_withdraw.get_yearly_amount(req.year).await {
            Ok(api_response) => {
                info!(
    ...
    async fn find_monthly_transaction_amount(
        ...
        match self.di.stats_transaction.get_monthly_amount(req.year).await {
            Ok(api_response) => {
                info!(
    ...
    async fn find_yearly_transaction_amount(
        ...
        match self.di.stats_transaction.get_yearly_amount(req.year).await {
            Ok(api_response) => {
                info!(
    ...
    async fn find_monthly_transfer_sender_amount(
        ...
        match self
            .di
            .stats_transfer
            .get_monthly_amount_sender(req.year)
            .await
        {
            Ok(api_response) => {
                info!(
    ...
    async fn find_yearly_transfer_sender_amount(
        ...
        match self
            .di
            .stats_transfer
            .get_yearly_amount_sender(req.year)
            .await
        {
            Ok(api_response) => {
                info!(
    ...
    async fn find_monthly_transfer_receiver_amount(
        ...
        match self
            .di
            .stats_transfer
            .get_monthly_amount_receiver(req.year)
            .await
        {
            Ok(api_response) => {
                info!(
    ...
    async fn find_yearly_transfer_receiver_amount(
        ...
        match self
            .di
            .stats_transfer
            .get_yearly_amount_receiver(req.year)
            .await
        {
            Ok(api_response) => {
                info!(
    ...
    async fn create_card(
        ...
        match self.di.card_command.create(&domain_req).await {
            Ok(api_response) => {
                info!(
                    "✅ Successfully created card for user_id={}",
                    domain_req.user_id
                );
    ...
    async fn update_card(
        ...
        match self.di.card_command.update(&domain_req).await {
            Ok(api_response) => {
    ...
    async fn trashed_card(
        ...
        match self.di.card_command.trash(req.card_id).await {
            Ok(api_response) => {
    ...
    async fn restore_card(
        ...
        match self.di.card_command.restore(req.card_id).await {
            Ok(api_response) => {
    ...
    async fn delete_card_permanent(
        ...
        match self.di.card_command.delete(req.card_id).await {
            Ok(api_response) => {
            ...
            Err(e) => {
                error!(
                    "❌ Failed to permanently delete card_id={}: {e:?}",
                    req.card_id
                );
                Err(AppErrorGrpc::from(e).into())
            }
    ...
    async fn restore_all_card(
        ...
        match self.di.card_command.restore_all().await {
            Ok(api_response) => {
    ...
    async fn delete_all_card_permanent(
        ...
        match self.di.card_command.delete_all().await {
            Ok(api_response) => {
