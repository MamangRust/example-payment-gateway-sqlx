...
pub type DynTransactionStatsMethodByCardNumberService =
    Arc<dyn TransactionStatsMethodByCardNumberServiceTrait + Send + Sync>;

#[async_trait]
pub trait TransactionStatsMethodByCardNumberServiceTrait {
