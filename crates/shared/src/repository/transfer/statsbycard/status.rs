use crate::{
    abstract_trait::transfer::repository::statsbycard::status::TransferStatsStatusByCardRepositoryTrait,
...
pub struct TransferStatsStatusByCardRepository {
    db: ConnectionPool,
}

impl TransferStatsStatusByCardRepository {
...
#[async_trait]
impl TransferStatsStatusByCardRepositoryTrait for TransferStatsStatusByCardRepository {
