use crate::{
    abstract_trait::topup::repository::stats::amount::TopupStatsAmountRepositoryTrait,
...
pub struct TopupStatsAmountRepository {
    db: ConnectionPool,
}

impl TopupStatsAmountRepository {
...
#[async_trait]
impl TopupStatsAmountRepositoryTrait for TopupStatsAmountRepository {
