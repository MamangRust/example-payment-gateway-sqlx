use crate::{
    abstract_trait::topup::repository::stats::status::TopupStatsStatusRepositoryTrait,
...
pub struct TopupStatsStatusRepository {
    db: ConnectionPool,
}

impl TopupStatsStatusRepository {
...
#[async_trait]
impl TopupStatsStatusRepositoryTrait for TopupStatsStatusRepository {
