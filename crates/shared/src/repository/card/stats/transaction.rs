use crate::{
    abstract_trait::card::repository::stats::transaction::CardStatsTransactionRepositoryTrait,
...
pub struct CardStatsTransactionRepository {
    db: ConnectionPool,
}

impl CardStatsTransactionRepository {
...
#[async_trait]
impl CardStatsTransactionRepositoryTrait for CardStatsTransactionRepository {
