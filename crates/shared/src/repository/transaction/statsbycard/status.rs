use crate::{
    abstract_trait::transaction::repository::statsbycard::status::TransactionStatsStatusByCardRepositoryTrait,
...
pub struct TransactionStatsStatusByCardRepository {
    db: ConnectionPool,
}

impl TransactionStatsStatusByCardRepository {
...
#[async_trait]
impl TransactionStatsStatusByCardRepositoryTrait for TransactionStatsStatusByCardRepository {
    async fn get_month_status_success(
        ...
        for row in rows {
            ...
            result.push(TransactionModelMonthStatusSuccess {
                year,
                month,
                total_success,
                total_amount,
    ...
    async fn get_yearly_status_success(
        ...
        for row in rows {
            ...
            result.push(TransactionModelYearStatusSuccess {
                year,
                total_success,
                total_amount,
            });
    ...
    async fn get_month_status_failed(
        ...
        for row in rows {
            ...
            result.push(TransactionModelMonthStatusFailed {
                year,
                month,
                total_failed,
                total_amount,
    ...
    async fn get_yearly_status_failed(
        ...
        for row in rows {
            ...
            result.push(TransactionModelYearStatusFailed {
                year,
                total_failed,
                total_amount,
            });
