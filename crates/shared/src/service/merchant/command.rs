use crate::{
    domain::requests::merchant::{CreateMerchantRequest, UpdateMerchantRequest, UpdateMerchantStatus},
    errors::ServiceError,
...
pub trait MerchantCommandServiceTrait {
    async fn create(&self, request: CreateMerchantRequest) -> Result<MerchantModel, ServiceError>;
    ...
    async fn trash(&self, id: String) -> Result<MerchantModel, ServiceError>;
    async fn restore(&self, id: String) -> Result<MerchantModel, ServiceError>;
    async fn delete(&self, id: String) -> Result<MerchantModel, ServiceError>;
