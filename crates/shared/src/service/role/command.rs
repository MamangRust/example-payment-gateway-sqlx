...
pub trait RoleCommandServiceTrait {
    ...
    async fn trash(&self, id: String) -> Result<ApiResponse<RoleResponse>, ServiceError>;
    async fn restore(&self, id: String) -> Result<ApiResponse<RoleResponse>, ServiceError>;
    async fn delete(&self, id: String) -> Result<ApiResponse<RoleResponse>, ServiceError>;
