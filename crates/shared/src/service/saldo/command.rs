...
pub trait SaldoCommandServiceTrait {
    ...
    async fn trash(&self, id: String) -> Result<ApiResponse<SaldoResponseDeleteAt>, ServiceError>;
    async fn restore(&self, id: String) -> Result<ApiResponse<SaldoResponse>, ServiceError>;
    async fn delete(&self, id: String) -> Result<ApiResponse<SaldoResponse>, ServiceError>;
